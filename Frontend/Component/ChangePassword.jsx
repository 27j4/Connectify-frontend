...
const Card = ({ children, className }) => {
  return (
    <div
      className={`border border-gray-300 rounded-lg shadow-sm p-2 ${className}`}
    >
      {children}
    </div>
  );
    ...
    <form className="w-full max-w-sm mx-auto rounded-lg my-24">
      ...
      <CardContent>
        <div className="space-y-2">
          ...
          <input
            ...
            required
            type="old-password"
            className="w-full px-3 py-2 mt-1 border border-gray-300 rounded-md shadow-sm text-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
          />
        </div>
      </CardContent>
      <CardContent>
      ...
      <CardFooter>
        <button
          ...
          className="py-2 px-4 bg-blue-600 text-white rounded-md shadow-sm text-sm font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-100 w-full"
        >
          Update Password
        </button>
      </CardFooter>
